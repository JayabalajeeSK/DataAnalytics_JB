...
select PaymentMethod,count(distinct paymentmethod) [Distinct Pay Mode] from dbo.Sales -- not include null, include only unique rows
group by PaymentMethod

select PaymentMethod,count(paymentmethod) [Pay Mode] from dbo.Sales -- not include null, include all other valid rows
group by PaymentMethod

select PaymentMethod,count(*) [Pay Mode] from dbo.Sales -- include null and include all other valide rows
group by PaymentMethod